...
{
    private readonly IFizzBuzzUseCase _useCase = new FizzBuzzUseCase(
        new FizzBuzzService(new FizzBuzzEvaluator()),
        new InMemoryFizzBuzzStatisticsRepository(),
        NullLogger<FizzBuzzUseCase>.Instance);
